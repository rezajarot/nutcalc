...
@protocol MediumViewControllerDelegate;
...
@interface MediumViewController : UIViewController<AVAudioPlayerDelegate> {	
    id <MediumViewControllerDelegate> delegate;
	
	//IBOutlet UIImageView *fanLeft;
	//IBOutlet UIImageView *fanLeft_1;
	
	//IBOutlet UIImageView *fanRight;
	//IBOutlet UIImageView *fanRight_1;
	
	IBOutlet UIImageView *ball;
	//IBOutlet UIImageView *frontView;
	//IBOutlet UIImageView *frontView1;
...
@property (nonatomic, assign) id <MediumViewControllerDelegate> delegate;
...
@protocol MediumViewControllerDelegate<NSObject>
@optional
