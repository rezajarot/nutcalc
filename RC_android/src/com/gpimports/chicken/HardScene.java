...
public class HardScene extends BaseExample{
	...
	private Texture mHardBackgoundTexture;
	...
	private TextureRegion mHardBackgroundRegion;
	...
	private Sprite mHardBackgroundSprite;
	...
	private Music mHardBackMusic = null;
	...
	public void onLoadResources() {
		mHardBackgoundTexture = new Texture(1024, 1024, TextureOptions.DEFAULT);
		...
		mHardBackgroundRegion = TextureRegionFactory.createFromAsset(mHardBackgoundTexture, this, "gfx/" + strImgSuf + "/background_lvl3.png", 0, 0);
		...
		mRecycleTextureRegion = TextureRegionFactory.createFromAsset(mRecycleTexture, this, "gfx/" + strImgSuf + "/bucket_lvl3.png", 0, 0);
		...
		mEngine.getTextureManager().loadTextures(mHardBackgoundTexture, mArrowTexture, mScoreBoardTexture, mWindValueTexture,
	...
	public Scene onLoadScene() {
		...
		mScene.getLayer(0).registerTouchArea(mHardBackgroundSprite);
	...
	private void loadSound()
	{
		mSounds = new Sound[6];
		try{
			mHardBackMusic = MusicFactory.createMusicFromAsset(mEngine.getMusicManager(), this, "mfx/Level_Hard_Background.mp3");
			mSounds[0] = SoundFactory.createSoundFromAsset(mEngine.getSoundManager(), this, "mfx/Level_Hard_BounceIn.wav");
			...
			mSounds[4] = SoundFactory.createSoundFromAsset(mEngine.getSoundManager(), this, "mfx/Level_Hard_Miss.wav");
			mSounds[5] = SoundFactory.createSoundFromAsset(mEngine.getSoundManager(), this, "mfx/GettingPrettyGood_1_Loud.mp3");
	...
	private void setLayer_1() {
		if (strImgSuf == "med") {
			mRecycleSprite = new Sprite(148 * scaled_width, 131 * scaled_height, mRecycleTextureRegion);
		} else {
			mRecycleSprite = new Sprite(222 * scaled_width, 237 * scaled_height, mRecycleTextureRegion);
		}
	...
	{
		// background
		mHardBackgroundSprite = new Sprite(0, 0, mHardBackgroundRegion);
		mHardBackgroundSprite.setSize(mHardBackgroundRegion.getWidth() * scaled_width, mHardBackgroundRegion.getHeight() * scaled_height);
		mScene.getLayer(0).addEntity(mHardBackgroundSprite);
	...
	private void loadTrackMaker()
	{
		...
		mTrackMaker.setLevel(Global.LV_3);
